...
#Region "Form Load/Unload"
    ...
    Private Sub frmMain_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Upgrade to SQL CE Engine
            Dim bracketSDFFile As String = "C:\mwmotion\Toyota Cell Berea Use this Version\Toyota Cell Berea Use this Version\Config data\Bracket.sdf"
            Dim passwordSDFFile As String = "C:\mwmotion\Toyota Cell Berea Use this Version\Toyota Cell Berea Use this Version\Config data\Password.sdf"
            Dim settingsSDFFile As String = "C:\mwmotion\Toyota Cell Berea Use this Version\Toyota Cell Berea Use this Version\Config data\Settings.sdf"

            Upgrade(bracketSDFFile, "mwmotion")
            Upgrade(passwordSDFFile, "mwmotion")
            Upgrade(settingsSDFFile, "mwmotion")
...
#Region "Vision Controls"
    ...
    Private Sub btnTrainExisting_Click(ByVal Sender As Object, ByVal eventArgs As System.EventArgs) Handles btnTrainExistingLocateGlass.Click, btnTrainExistingBracketConveyor.Click,
                    ...
                    btnTrainExistingPassenger.Click
        Dim btn As Button
    ...
    Private Sub btnSearch_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnSearchSettingsLocateGlass.Click, btnSearchSettingsBracketConveyor.Click,
                        ...
                        btnSearchSettingsPassenger.Click
        Dim btn As Button
        Side = CurrentVisionTab
        btn = DirectCast(eventSender, Button)
        Select Case btn.Name
...
#Region "Vision Routines"
    ...
    Public Sub btnLocate_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnLocateLocateGlass.Click, btnLocateOnlyLocateGlass.Click,
        ...
        btnLocateOnlyBracketTape.Click, btnLocateOnlyBracketVerify.Click
        Dim btn As Button
        btn = DirectCast(eventSender, Button)
        Try
...
#Region "Up Downs"
    ...
    Private Sub updnScoreLimit_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles updnScoreLimit.ValueChanged, updnScoreLimitBracketconveyor.ValueChanged, updnScoreLimitCenter.ValueChanged, updnScoreLimitCenterVerify.ValueChanged, updnScoreLimitDriver.ValueChanged, updnScoreLimitPassenger.ValueChanged,
        ...
        Try
            Dim updn As NumericUpDown = DirectCast(sender, NumericUpDown)
...
#Region "File System"
    ...
    Private Sub TrainBlobs(Sender As Object, e As EventArgs) Handles btnDriverTrainBlob.Click, btnCenterTrainBlob.Click, btnPassengerTrainBlob.Click, btnTrainBracketPrimerReference.Click,
    ...
    Private Sub SaveBlobs(sender As Object, e As EventArgs) Handles btnPassengerSaveBlob.Click, btnCenterSaveBlob.Click, btnDriverSaveBlob.Click, btnSaveBracketPrimerReference.Click,
...
#Region "PLC"
    ...
    Public Sub lblReset(sender As Object, e As EventArgs) Handles lblmessagedesc.DoubleClick, lblVisionMessageBracket.DoubleClick, lblVisionMessageBracketConveyor.DoubleClick, lblVisionMessageBracketTape.DoubleClick, lblVisionMessageBracketVerify.DoubleClick, lblVisionMessageCenter.DoubleClick,
